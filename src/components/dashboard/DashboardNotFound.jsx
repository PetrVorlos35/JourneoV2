...
const DashboardNotFound = () => {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center h-full w-full min-h-[80dvh] overflow-hidden text-[#1d1d1f] dark:text-[#f5f5f7] font-sans px-4">
      ...
      >
        ...
        <h1 className="text-3xl sm:text-5xl font-bold tracking-tight text-black dark:text-white">
          {t('notFound.title')}
        </h1>
