...
import { ArrowLeft, Save, MapPin, Calendar, Pencil, Check, PackageOpen, Link as LinkIcon, Plus, Trash2, ExternalLink, Image as ImageIcon, Printer } from 'lucide-react';
...
const TripDetail = ({ trips, onUpdateTrip }) => {
  ...
  const [activeView, setActiveView] = useState(0); // 0, 1... for days, 'packing', 'documents'
  ...
  return (
    <div className="max-w-5xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        <div>
          <button onClick={handleBack} className="inline-flex items-center text-blue-600 dark:text-blue-500 hover:text-blue-700 dark:hover:text-blue-400 mb-4 font-medium transition-colors">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div className="lg:col-span-3 print:col-span-1 print:block">
          <div className={`${activeView === 'packing' ? 'block' : 'hidden print:block'} mb-8 print:mb-12`}>
          ...
          <div className={`${activeView === 'documents' ? 'block' : 'hidden print:block'} mb-8 print:mb-12`}>
            <div className="bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 print:bg-white print:border-none p-6 md:p-8 rounded-2xl print:p-0">
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white print:text-black mb-6 border-b border-gray-200 dark:border-white/10 print:border-black pb-4 flex items-center gap-3">
          ...
          <div className={`${activeView === 'diary' ? 'block' : 'hidden'} print:hidden`}>
          ...
          <div className={`${typeof activeView === 'number' ? 'block' : 'hidden print:block'} print:break-before-page`}>
