  ...
  return (
    <div className="relative min-h-[100dvh] w-full flex flex-col items-center justify-center p-4 overflow-hidden bg-[#fbfbfd] dark:bg-black text-[#1d1d1f] dark:text-[#f5f5f7] font-sans">
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none select-none z-0">
        <span className="text-[35vw] font-black tracking-tighter text-black/[0.03] dark:text-white/[0.03] leading-none">
          404
        </span>
      </div>
      ...
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none flex justify-center items-center">
        <div className="w-[800px] h-[800px] rounded-[100%] bg-blue-500/5 dark:bg-blue-500/10 blur-[120px]" />
      </div>
      ...
      <motion.div 
        ...
        className="relative z-10 flex flex-col items-center text-center max-w-md gap-4 pt-16"
      >
