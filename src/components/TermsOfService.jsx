...
const TermsOfService = () => {
  ...
  const sections = [
    t('termsOfService.section1', { returnObjects: true }),
    t('termsOfService.section2', { returnObjects: true }),
    t('termsOfService.section3', { returnObjects: true }),
    t('termsOfService.section4', { returnObjects: true }),
    t('termsOfService.section5', { returnObjects: true }),
    t('termsOfService.section6', { returnObjects: true }),
  ];
