...
-- ── Místa na mapě ────────────────────────────────────────────
-- Bod na mapě. Může patřit k výletu (a volitelně ke dni itineráře),
-- nebo být osobní — trip_id NULL = wishlist mimo výlet.
...
-- ── Cache geokódování ────────────────────────────────────────
-- Odpovědi Nominatimu (viz lib/geocode.js). Šetří jeho rate limit
-- a dělá z dávkového importu míst z itineráře instantní operaci.
